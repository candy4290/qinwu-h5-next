...
export default function OtherOr(props: { currentOrg: CurrentOrgInterface }) {
    ...
    useEffect(() => {
        ...
        axios.get(apis.getTjData, { /* 当日排班数+当前排班数+当前打卡 */
            params: {
                orgCode: currentOrg.orgCode,
            }
        }).then((rsp: any) => {
    ...
    return (
        <div className='py-5 px-6'>
            ...
            {
                hasDownOrgs &&
                <div className='mt-[14px] bg-[#008fff] rounded-[23px] h-[45px] text-center text-lg font-semibold text-white' onClick={() => setCurrentOrg((org: any) => {
