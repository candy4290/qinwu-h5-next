      ...
      Promise.all([
        axios.get(apis.getDownOrgsInfo, {
          ...
          params: {
            ...
            postTypeId: postTypeId.slice(0, tempIdx),
          },
        }),
        axios.get(apis.getDownOrgsInfo, {
          /* 动中 */
          params: {
            jgsx,
            orgCode: currentOrg.orgCode,
            postTypeId: postTypeId.slice(tempIdx + 1),
          },
        }),
      ]).then((rsp: any) => {
        const temp: any = [];
...
export default function Shiju(props: { currentOrg: CurrentOrgInterface }) {
  ...
  return (
    <div>
      ...
      <div className="mt-[-196px] rounded-t-[40px] bg-mitWhite pt-6">
