...
export default function Fenju(props: { currentOrg: CurrentOrgInterface }) {
  ...
  return (
    <div className="fj px-5 pb-6">
      ...
      <div
        className="mt-[14px] h-[45px] rounded-3xl bg-mitBlue text-center text-lg font-semibold leading-[45px] text-white"
        onClick={() =>
